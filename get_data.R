...
combiner <- function(output, var.name) {
  ...
  output <- output %>%
    ...
    mutate(variable = ifelse(variable == "scheduled", "Scheduled law", variable),
           ...
           variable = ifelse(variable == "survivor.js75", "75 percent survivor benefit", variable),
           variable = ifelse(variable == "taxmax90", "90 percent tax max", variable),
           variable = ifelse(variable == "taxmax90.fica13.4", "90% tax max and 13.4% payroll tax", variable),
           variable = ifelse(variable == "fica13.4", "13.4 percent payroll tax", variable),
           ...
           variable = ifelse(variable == "fica14", "14.4 percent payroll tax", variable),
           variable = ifelse(variable == "fica15", "15.4 percent payroll tax", variable),
